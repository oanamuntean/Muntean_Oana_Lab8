...
namespace Muntean_Oana_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Muntean_Oana_Lab8Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Muntean_Oana_Lab8Context context, string[] selectedCategories, Book bookToUpdate)
        {
